...
export default function NavBar() {
  const { setActualPage, screenWidth, setNavBarVisible, navBarVisible } =
    useChatContext();

  return (
    <nav
      className={`${navBarVisible ? '' : 'hidden'} custom-glassmorphism-bg w-full flex md:flex md:w-[20rem] lg:w-[24rem] h-screen overflow-hidden border-r border-neutral-800 flex-col gap-4`}
    >
      <Logo />
